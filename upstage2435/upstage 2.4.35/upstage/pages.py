...
class MediaEditPage(Workshop):
    ...
    def text_list_media(self, request):
        ...
        for k,v in media:
            ...
            add = '<table id="%s_%s_%s_%s" onclick="getMedia(\'%s\',\'%s\',\'%s\')"><tr><td>' %(v['media'], v['typename'], v['uploader'], v['stages'], v['media'], v['typename'], v['type'])+tag+'</td></tr><tr><td class="disableLink"><b>Name:&nbsp;</b>%s</td></tr><tr><td class="disableLink"><b>Uploader:&nbsp;</b>%s</td></tr></tr><tr><td class="disableLink"><b>Type:&nbsp;</b>%s</td></tr></table><input name="hidden%s" type="hidden" value="%s" />' % (v['name'], v['uploader'], v['typename'], v['media'], v['tags'])
            msg += add
            num += 1
        return msg
